...
public class Movie extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 575932018519294327L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Movie\",\"namespace\":\"com.improving.demo.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"title\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"release_year\",\"type\":\"int\"}],\"arg.properties\":{\"options\":[{\"id\":294,\"title\":\"Die Hard\",\"release_year\":1988},{\"id\":354,\"title\":\"Tree of Life\",\"release_year\":2011},{\"id\":782,\"title\":\"A Walk in the Clouds\",\"release_year\":1995},{\"id\":128,\"title\":\"The Big Lebowski\",\"release_year\":1998},{\"id\":780,\"title\":\"Super Mario Bros.\",\"release_year\":1993}]}}");
   ...
   */
  public static com.improving.demo.avro.Movie.Builder newBuilder() {
    return new com.improving.demo.avro.Movie.Builder();
  }
   ...
   * @return A new Movie RecordBuilder
   */
  public static com.improving.demo.avro.Movie.Builder newBuilder(com.improving.demo.avro.Movie.Builder other) {
    if (other == null) {
      return new com.improving.demo.avro.Movie.Builder();
    } else {
      return new com.improving.demo.avro.Movie.Builder(other);
    }
  }
   ...
   * @return A new Movie RecordBuilder
   */
  public static com.improving.demo.avro.Movie.Builder newBuilder(com.improving.demo.avro.Movie other) {
    if (other == null) {
      return new com.improving.demo.avro.Movie.Builder();
    } else {
      return new com.improving.demo.avro.Movie.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Movie>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.improving.demo.avro.Movie.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.improving.demo.avro.Movie other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.improving.demo.avro.Movie.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.improving.demo.avro.Movie.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.improving.demo.avro.Movie.Builder setTitle(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.improving.demo.avro.Movie.Builder clearTitle() {
      title = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.improving.demo.avro.Movie.Builder setReleaseYear(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.improving.demo.avro.Movie.Builder clearReleaseYear() {
