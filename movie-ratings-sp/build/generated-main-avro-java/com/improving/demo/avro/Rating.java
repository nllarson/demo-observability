...
public class Rating extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -8850879768086993416L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Rating\",\"namespace\":\"com.improving.demo.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"long\",\"arg.properties\":{\"options\":[294,354,782,128,780]}},{\"name\":\"rating\",\"type\":\"double\",\"arg.properties\":{\"range\":{\"min\":0.1,\"max\":10.0}}}]}");
   ...
   */
  public static com.improving.demo.avro.Rating.Builder newBuilder() {
    return new com.improving.demo.avro.Rating.Builder();
  }
   ...
   * @return A new Rating RecordBuilder
   */
  public static com.improving.demo.avro.Rating.Builder newBuilder(com.improving.demo.avro.Rating.Builder other) {
    if (other == null) {
      return new com.improving.demo.avro.Rating.Builder();
    } else {
      return new com.improving.demo.avro.Rating.Builder(other);
    }
  }
   ...
   * @return A new Rating RecordBuilder
   */
  public static com.improving.demo.avro.Rating.Builder newBuilder(com.improving.demo.avro.Rating other) {
    if (other == null) {
      return new com.improving.demo.avro.Rating.Builder();
    } else {
      return new com.improving.demo.avro.Rating.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Rating>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.improving.demo.avro.Rating.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.improving.demo.avro.Rating other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.improving.demo.avro.Rating.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.improving.demo.avro.Rating.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.improving.demo.avro.Rating.Builder setRating(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.improving.demo.avro.Rating.Builder clearRating() {
