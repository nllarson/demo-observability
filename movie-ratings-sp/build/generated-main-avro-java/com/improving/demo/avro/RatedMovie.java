 ...
 */
package com.improving.demo.avro;
...
public class RatedMovie extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5419080955544844789L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"RatedMovie\",\"namespace\":\"com.improving.demo.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"title\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"release_year\",\"type\":\"int\"},{\"name\":\"rating\",\"type\":\"double\"}]}");
   ...
   */
  public static com.improving.demo.avro.RatedMovie.Builder newBuilder() {
    return new com.improving.demo.avro.RatedMovie.Builder();
  }
   ...
   * @return A new RatedMovie RecordBuilder
   */
  public static com.improving.demo.avro.RatedMovie.Builder newBuilder(com.improving.demo.avro.RatedMovie.Builder other) {
    if (other == null) {
      return new com.improving.demo.avro.RatedMovie.Builder();
    } else {
      return new com.improving.demo.avro.RatedMovie.Builder(other);
    }
  }
   ...
   * @return A new RatedMovie RecordBuilder
   */
  public static com.improving.demo.avro.RatedMovie.Builder newBuilder(com.improving.demo.avro.RatedMovie other) {
    if (other == null) {
      return new com.improving.demo.avro.RatedMovie.Builder();
    } else {
      return new com.improving.demo.avro.RatedMovie.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RatedMovie>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.improving.demo.avro.RatedMovie.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.improving.demo.avro.RatedMovie other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.improving.demo.avro.RatedMovie.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.improving.demo.avro.RatedMovie.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.improving.demo.avro.RatedMovie.Builder setTitle(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.improving.demo.avro.RatedMovie.Builder clearTitle() {
      title = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.improving.demo.avro.RatedMovie.Builder setReleaseYear(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.improving.demo.avro.RatedMovie.Builder clearReleaseYear() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.improving.demo.avro.RatedMovie.Builder setRating(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.improving.demo.avro.RatedMovie.Builder clearRating() {
